...
import BasicPrelude hiding (id, lookup, isPrefixOf)
import Data.HashMap.Strict (fromList, filterWithKey, lookup, (!))
...
fieldToMap fs = fromList $ mapMaybe (\x -> case fieldName x of
